...
TEMPLATE_REPO_PATH = 'agents/dataproc_template_agent/sources/git/dataproc_template'
GIT_PATH = 'agents/dataproc_template_agent/sources/git'
MODEL = 'gemini-2.5-pro'
TEMP_DIR_PATH = 'agents/dataproc_template_agent/temp'
